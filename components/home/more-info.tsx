...
export default function MoreInfo() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentIndex((prevIndex) => (prevIndex + 1) % moreInfoData.length);
    }, 5000);
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-zinc-600 text-base sm:text-lg md:text-xl max-w-md mx-auto md:mx-0">
                  {moreInfoData[currentIndex].description}
                </p>
                  ...
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-[90%] h-[90%]">
                        <Image
                          src={
                            moreInfoData[currentIndex].image ||
                            "/placeholder.svg"
                          }
                          alt={moreInfoData[currentIndex].alt}
                          fill
